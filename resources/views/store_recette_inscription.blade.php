        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-body">
                            <h3 class="header-title text-center"> Recette pour les préinscriptions et les inscriptions</h3> <br>
                            ...
                            <form method="POST" action="{{route('add-recette-inscription')}}"  enctype="multipart/form-data">
                                @csrf
