        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-body">
                            <h3 class="header-title text-center">Type de recette par composante</h3> <br>
                            ...
                            <form class="needs-validation" action="{{route('liste-recette-par-composante')}}" method="post" >
                                @csrf
                                <div class="row">
