        ...
        <div class="page-title-box">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h4 class="page-title mb-1">Université des Comores</h4>
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item active">Service de la comptabilité</li>
                        </ol>
                    </div>
                    <div class="col-md-4">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xl-4">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="header-title mb-4">Solde</h5>
                                <div class="media">
