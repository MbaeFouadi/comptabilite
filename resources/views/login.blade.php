...
<!-- Mirrored from themesdesign.in/xoric/layouts/blue/vertical/auth-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 30 May 2023 13:22:17 GMT -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center mb-5">
                        <a href="index.html" class="logo"><img src="assets/images/udc.png" height="150" width="150" alt="logo"></a>
                        <!-- <h5 class="font-size-16 text-white-50 mb-4">UDC</h5> -->
                    </div>
                </div>
            </div>
            <!-- end row -->
                ...
                <div class="col-xl-5 col-sm-8">
                    <div class="card">
                        <div class="card-body p-4">
                            <div class="p-2">
                                <h5 class="mb-5 text-center">Veuillez vous connecter</h5>
