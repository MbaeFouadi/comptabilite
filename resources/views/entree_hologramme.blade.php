        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-body">
                            <h3 class="header-title text-center">Faire une entrée hologramme</h3> <br>
                            ...
                            <form class="needs-validation" novalidate method="post" action="{{ route('add_entree_hologramme') }}">
